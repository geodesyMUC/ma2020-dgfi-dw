function [lat,lon] = importTectonic(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [LAT,LON] = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   [LAT,LON] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [lat,lon] = importfile('All_boundaries.txt',1, 12377);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/09/02 08:34:56
