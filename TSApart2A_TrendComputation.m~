...
%function VisualizeTS_Trend_Outliers_ITRF_ENU(t_obs, obs, obs_outlier_logical, obs_names, t_trend, trends, title_strings, t_jump, jump_categories, jumpITRF)
figure
VisualizeTS_Trend_Outliers_ITRF_ENU(...
    ...
    {'Earthquake', 'HWSW Change', 'Unknown'}, ...
    readITRFChanges(itrf_changes_textfile)...
    )
