...
% stationname = 'MZAE'; % Santa Rosa, Argentina
...
EQLogical = logical(currStationJumps{(jumps0 >= 0), 4}); 
% 1=eq, 0=other. negative time indicates jump happened before TS started
...
nEQJumps = length(EQHJump); % Only EQ Jumps -> n of transients
...
for i = 1:3
    ...
    [y, result_parameterC, xEst, outlierLogical] = computeTrendIRLS(...
        ...
        EQHJump, ... % eqs jumps: time in years since t0
